    ...
    return(
        <div className="c-skills">
            ...
            <div className="c-skills__box">
                ...
                <img className={counter === 1 ? "c-skills__btn c-skills__btn--none" : "c-skills__btn"} src={Button} alt="button" onClick={counter === 1 ? () => { setCounter(0) } : () => { setCounter(1) }}/>
                {counter === 1 && 
                    <div className="c-skills__accordion">
                        
                   <button className="c-skills__close" type="button" onClick={counter === 1 ? () => { setCounter(0) } : () => { setCounter(1) }}>x</button>
                ...
                <img className={counter === 2 ? "c-skills__btn c-skills__btn--none" : "c-skills__btn"} src={Button} alt="button" onClick={counter === 2 ? () => { setCounter(0) } : () => { setCounter(2) }}/>
                {counter === 2 && 
                    <div className="c-skills__accordion">
                        
                   <button className="c-skills__close" type="button" onClick={counter === 2 ? () => { setCounter(0) } : () => { setCounter(2) }}>x</button>
